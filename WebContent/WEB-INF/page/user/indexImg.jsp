...
<div id="altContent"></div>
		 ...
		 <div id="avatar_priview" style=" margin-top:15px;float: right; margin-right:10px;"><img id="aa" width="182" height="167" src="<%=request.getContextPath() %>/stageUpload/indexHeadImage/<s:property value="#request.userId"/>.png?id=<%=new Date() %>" 
