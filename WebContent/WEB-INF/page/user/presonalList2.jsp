...
$().ready(function(){	
		...
		//动态评分
		var imgSrc = '<img src="<%=request.getContextPath() %>/theme/images2/tu96.jpg" />&nbsp;';
		var imgSrc1 = '<img src="<%=request.getContextPath() %>/theme/images2/x2.png" />&nbsp;';
		var imgSrc2 = '<img src="<%=request.getContextPath() %>/theme/images2/x1x.png" />&nbsp;';
...
/* 		.gr-nex2-right9 ul li a:hover { height:30px; line-height:30px; font-family:"微软雅黑","宋体"; color:#D12127; font-size:12px;} */
  ...
  <body style="background: url('<%=request.getContextPath() %>/theme/images2/grbj.gif');font-family: 微软雅黑;color: #333333">
...
<!--top4-->
<div class="qy-banner">
  <div class="qy-bleft l"><img src="<%=request.getContextPath() %>/theme/images2/tu201.png" width="4" height="215"  /></div>
     	...
     	<tr>
     						...
     						<table>
     							<tr>
     								<td style="font-size: 24px;color: #333333; font-weight: bold;">
     									<s:if test="#request.userInfo.sex==1"><img src="<%=request.getContextPath() %>/theme/images2/sex-n.png" /></s:if>
     									<s:else><img src="<%=request.getContextPath() %>/theme/images2/sex-v.png" /></s:else>
			     						...
			     						<s:if test="#request.qyUserInfo==1">
			     							...
			     							<s:if test="#request.qyUser.rzState==3">
								         		<img src="<%=request.getContextPath() %>/theme/images2/tu95.jpg" width="15" height="17" />
								         	</s:if>
								         	<s:else>
								         		<img src="<%=request.getContextPath() %>/theme/images2/tu95_1.jpg" width="15" height="17" />
							         	</s:else>
			     						</s:if>
			     						<s:else>
			     							<s:if test="#request.user.rzState==3">
								         	<a style="color:#37bc07;font-size:14px;margin:0 10px"><img src="<%=request.getContextPath() %>/theme/images2/tu95.jpg" width="15" height="17" />&nbsp;&nbsp;实名认证</a>
								         	&nbsp;&nbsp;&nbsp;
								         	</s:if>
								         	<s:else>
								         		<a style="color:#cc0000;font-size:14px;margin:0 10px"><img src="<%=request.getContextPath() %>/theme/images2/tu95_1.jpg" width="15" height="17" />&nbsp;&nbsp;未认证</a>
								         	&nbsp;&nbsp;&nbsp;
							         	</s:else>
			     						</s:else>
     							...
     							<tr>
     								<td style="font-size: 12px;font-weight: bold;">
     									...
     									<img src="<%=request.getContextPath() %>/theme/images2/tu210.png" onmouseover="setTimeout(showdetails,100);" onmouseout="setTimeout(hidedetails,100)"/>
     									<div id="windows1" style="display:none; background-image:url(<%=request.getContextPath() %>/theme/images2/tu207.png);width: 186px;height: 54px;position: absolute;z-index: 1000;left: 293px;top: 7px;">
     										<table cellpadding="4">
     											<tr><td><span style="color: #333333;">每次获得一次赞或者被分享一次都会加1个人气值</span></td></tr>
     										</table>
     									</div>
     									<div id="windows2" style="display:none; background-image:url(<%=request.getContextPath() %>/theme/images2/tu206.png);width: 186px;height: 54px;position: absolute;z-index: 1000;left: 10px;top: 223px;">
     										<table cellpadding="4">
     		...
     		<td>
     			<table width="175" cellpadding="3" style="border-left: #ccc 1px solid;margin-top: 7px;" >
     				<tr>
     					<td height="51">
     						<img src="<%=request.getContextPath() %>/theme/images2/tu204.png" width="164" height="51" onclick="qianYueTa()" style="cursor: pointer;"/>
     					</td>
     				</tr>
     				<tr>
     					...
     					<% if(userSession==null){
							%>
							<span style="color:#FF60C9;padding-left:28px;cursor: pointer;" onclick="parent.showPop(1,'<%=request.getContextPath() %>/loginHtml.htm');event.cancelBubble=true;"><img src="<%=request.getContextPath() %>/theme/images2/tu203.png" width="20" height="17" />&nbsp;赞一个</span>
							<% }else{%>
								<span style="color:#FF60C9;padding-left:28px;cursor: pointer;" onclick="addDing(<s:property value="#request.id"/>,1)"><img src="<%=request.getContextPath() %>/theme/images2/tu203.png" width="20" height="17" />&nbsp;赞一个</span>
							<%} %>
     					</td>
     				</tr>
     				<tr>
  ...
  <div class="qy-bright l"><img src="<%=request.getContextPath() %>/theme/images2/tu202.png" width="4" height="215" /></div>
</div>
...
<table class="gr-nex">
    ...
    <div class="gr-nex1-top" style="margin-right:10px;margin-top: 10px;">
     <p><img src="<%=request.getContextPath() %>/theme/images2/tu97.jpg" width="304" height="7" /></p>
    ...
    <!-- 会员详情 下 信息 开始 -->
      <s:action name="userViewLeft" namespace="" executeResult="true">
       ...
       <div id="pop-up" style="display:none; background-image:url(<%=request.getContextPath() %>/theme/images2/pop-up.png);width: 240px;height: 124px;position: absolute;z-index: 1000;" >
	...
	<s:action name="schedule" executeResult="true" namespace="">
     ...
     <p><img src="<%=request.getContextPath() %>/theme/images2/tu99.jpg" width="304" height="7" /></p>
   </div>  
   ...
   <div>
    ...
    <div class="gr-nex1-left2">
       ...
       var imgSG1 = '<img src="<%=request.getContextPath() %>/theme/images2/m41.gif" />&nbsp;';
		var imgSG2 = '<img src="<%=request.getContextPath() %>/theme/images2/m42.gif" />&nbsp;';
		var imgSG3 = '<img src="<%=request.getContextPath() %>/theme/images2/m43.gif" />&nbsp;';
				...
				function(data) {
			    	if(data != null){
			    		$(data).each(function(index,val){
			    			...
			    			<% if(userSession==null){
							%>
							$("<div class='container2'><table width='228' style='background-color: #EBEBEB;height:20px;border:1px solid #D9D9D9;'><tr><td width='33%'align='center' title='赞一下' onclick='addDing("+this.id+",("+this.type+"+1))'  style='cursor: pointer;border-right:1px solid #D9D9D9;' ><img src=\"<%=request.getContextPath() %>/theme/images2/s1.png\" />&nbsp;"+this.ding+"</td><td width='33%'align='center' title='分享' onclick='share("+this.userId+","+this.id+",\""+this.url+"\",this,\""+this.intro+"\","+this.type+")' style='cursor: pointer;border-right:1px solid #D9D9D9;'><img src=\"<%=request.getContextPath() %>/theme/images2/s2.png\" />&nbsp;"+this.share+"</td><td width='33%'align='center' title='评论' onclick='parent.showPop(1,'<%=request.getContextPath() %>/loginHtml.htm');event.cancelBubble=true;' style='cursor: pointer;border-right:1px solid #D9D9D9;'><img src=\"theme/images2/s3.png\" />&nbsp;"+this.evaluate+"</td></tr></table><table ><tr><td width='228' align='center'>"+this.title+"</td></tr></table></div>").appendTo(_dl);
			    			<% }else{%>
								$("<div class='container2'><table width='228' style='background-color: #EBEBEB;height:20px;border:1px solid #D9D9D9;'><tr><td width='33%'align='center' title='赞一下' onclick='addDing("+this.id+",("+this.type+"+1))'  style='cursor: pointer;border-right:1px solid #D9D9D9;' ><img src=\"<%=request.getContextPath() %>/theme/images2/s1.png\" />&nbsp;"+this.ding+"</td><td width='33%'align='center' title='分享' onclick='share("+this.userId+","+this.id+",\""+this.url+"\",this,\""+this.intro+"\","+this.type+")' style='cursor: pointer;border-right:1px solid #D9D9D9;'><img src=\"<%=request.getContextPath() %>/theme/images2/s2.png\" />&nbsp;"+this.share+"</td><td width='33%'align='center' title='评论' onclick='openEvaView("+this.id+")' style='cursor: pointer;border-right:1px solid #D9D9D9;'><img src=\"<%=request.getContextPath() %>/theme/images2/s3.png\" />&nbsp;"+this.evaluate+"</td></tr></table><table ><tr><td width='228' align='center'>"+this.title+"</td></tr></table></div>").appendTo(_dl);
			    			<%} %>
...
<script type="text/javascript" src="http://v3.jiathis.com/code/jia.js" charset="utf-8"></script>
   ...
   <div class="gr-nex2-right7">
       <p class="gr-right7-z l"><img src="<%=request.getContextPath() %>/theme/images2/tu107.jpg" width="5" height="415" /></p>
      <div class="gr-right7-zz l">
       ...
       <p class="gr-right7-z l"><img src="<%=request.getContextPath() %>/theme/images2/tu109.jpg" width="4" height="415" /></p>
     </div>
...
<div id="aaa" style="background-image:url(<%=request.getContextPath() %>/theme/images2/x5.png);width:230px;height:35px; position: absolute;display: none;" onclick="addShare()">
