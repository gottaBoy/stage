...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function view(indexImgUrl){
		    ...
		    padding: 0,
		    title: '照片',
		    content: '<img onerror="handleImgLoadError(event);" src="<%=request.getContextPath() %>/stageUpload/indexHeadImage/'+indexImgUrl+'.png?id=<%=new Date() %>" />',
		    lock: true
		});
	}
		  ...
		  &nbsp;</td>        
	        ...
	        <td  align="center"  ><s:property value="#item[1].name"/>&nbsp;</td>
	         ...
	         <td  align="center"  >
		      ...
		      <img style="display: none;" onerror="$('#tuijian_'+<s:property value="#item[1].userId"/>).css('display','none');$('#tuijian1_'+<s:property value="#item[1].userId"/>).css('display','');" src="<%=request.getContextPath() %>/stageUpload/indexHeadImage/<s:property value="#item[1].userId"/>.png" />
	        	</td>
	        	</tr>
	        	</table>
