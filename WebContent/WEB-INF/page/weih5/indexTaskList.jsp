...
<body>
	<div class="works">
		...
		<ul id="infoList" class="mui-table-view mui-table-view-chevron" style="margin-top:0;">
			...
			<s:iterator value="#request.allTaskList" var="item" status="st">
		        <li class="mui-table-view-cell mui-media">
				<a class="mui-navigate-right" href="taskDetail.htm?taskId=<s:property value="#item.id"/>">
					<%-- <img class="mui-media-object mui-pull-left" src="http://www.d15t.com/stageUpload/headImage/<s:property value='#item.id'/>.png"> --%>
					<div class="mui-media-body">
						<s:property value="#item.title"/>
						<p class='mui-ellipsis'><s:property value="#item.content"/></p>
					</div>
				</a>
				</li>
	    	</s:iterator>	
